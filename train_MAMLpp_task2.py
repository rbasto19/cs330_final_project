...
if __name__ == '__main__':
    ...
    #START CURRICULUM ROUTINE (MY CONTRIBUTION)
    ...
    #END CURRICULUM ROUTINE (MY CONTRIBUTION)
    ...
    def get_per_step_loss_importance_vector(current_step):
        #MY CONTRIBUTION to add this here, but copied from the cited MAML++ paper
        """
    ...
    def train(it):
        model.train()
        optimizer.zero_grad()
        num_inner_loop_steps = args.inner_loop_steps
        batch_size_outer_loop = args.outer_batch_size 
